...
public struct BlossomColors: Codable, Sendable {
    ...
    public let ring_1: [RGBColor] // Inner ring - 8 colors
    public let ring_2: [RGBColor] // Outer ring - 16 colors
        ...
        guard let url = AppResourceBundle.url(
            ...
            return BlossomColors(
                ...
                ring_1: [
                    ...
                    RGBColor(r: 237, g: 216, b: 231),
                    RGBColor(r: 227, g: 215, b: 235),
                    RGBColor(r: 218, g: 231, b: 248),
                    RGBColor(r: 216, g: 237, b: 231),
