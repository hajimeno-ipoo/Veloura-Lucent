...
public enum BlossomConstants {
    ...
    public static let innerPetalCount: Int = 8

    /// Number of petals in the outer ring
    public static let outerPetalCount: Int = 16

    /// Distance from center to inner ring petals
    public static let innerRadius: CGFloat = 26

    /// Distance from center to outer ring petals
    public static let outerRadius: CGFloat = 48
    ...
    /// Brightness arc start angle in degrees (0° = 3 o'clock)
    public static let arcStartAngle: Double = -30

    /// Brightness arc end angle in degrees
    public static let arcEndAngle: Double = 30

    /// Opacity arc start angle in degrees
    public static let opacityArcStartAngle: Double = 150

    /// Opacity arc end angle in degrees
    ...
    public static let utilityBarWidth: CGFloat = 244
    public static let utilityBarHeight: CGFloat = 36
    public static let utilityBarSpacing: CGFloat = 6
    public static let utilityBarHorizontalPadding: CGFloat = 8
    public static let utilityButtonSize: CGFloat = 28
    public static let recentColorButtonSize: CGFloat = 24
    public static let recentColorSwatchSize: CGFloat = 18
    public static let recentColorLimit: Int = 6
}
