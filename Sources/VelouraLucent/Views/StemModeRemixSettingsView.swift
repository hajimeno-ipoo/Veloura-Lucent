            ...
            VStack(alignment: .leading, spacing: 4) {
                HStack(spacing: 6) {
                    ...
                    TermHelpButton(
                        title: "再ミックス調整",
                        reading: "さいみっくすちょうせい",
                        description: "全Stemの音量が0 dB、パンが0、Stem間の衝突回避が無効または0、全Stemの共通リバーブへの送信量と共通リバーブの戻り量が0の場合、再ミックス版は純粋加算版とほぼ同じ音になります。同じ設定でマスタリングすれば、最終音もほぼ同じです。いずれかが中立値ではない場合、その調整分だけ音量バランス、左右位置、帯域の重なり、空間感が変化します。"
                    )
                }
