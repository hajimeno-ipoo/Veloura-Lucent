...
struct ContentView: View {
    ...
    private var advancedSettingColumns: [GridItem] {
    ...
    private var loudnessControl: some View {
        sliderCard(
            ...
            quickActions: [
                SliderQuickAction(title: "余裕", action: { setTargetLoudness(-16.0) }),
                SliderQuickAction(title: "標準", action: { setTargetLoudness(-14.5) }),
                SliderQuickAction(title: "強め", action: { setTargetLoudness(-13.8) })
            ],
            stepperActions: (
                decrement: { adjustTargetLoudness(-0.1) },
                increment: { adjustTargetLoudness(0.1) }
            )
        ) {
            Slider(
                value: binding(
                    get: { Double(job.editableMasteringSettings.targetLoudness) },
                    set: { setTargetLoudness($0) }
                ),
                in: -18 ... -9,
                step: 0.1
            )
    ...
    private var truePeakControl: some View {
        sliderCard(
            ...
            quickActions: [
                SliderQuickAction(title: "安全", action: { setPeakCeiling(-1.5) }),
                SliderQuickAction(title: "標準", action: { setPeakCeiling(-1.0) }),
                SliderQuickAction(title: "攻める", action: { setPeakCeiling(-0.7) })
            ],
            stepperActions: (
                decrement: { adjustPeakCeiling(-0.1) },
                increment: { adjustPeakCeiling(0.1) }
            )
        ) {
            Slider(
                value: binding(
                    get: { Double(job.editableMasteringSettings.peakCeilingDB) },
                    set: { setPeakCeiling($0) }
                ),
                in: -2 ... -0.2,
                step: 0.1
            )
    ...
    private var dynamicsRetentionControl: some View {
        sliderCard(
            ...
            valueText: String(format: "%.0f%%", Double(job.editableMasteringSettings.dynamicsRetention) * 100),
            hintText: "サビの開放感を残したい時は高めにします。",
            scaleLabels: ["密度優先", "バランス", "開放感"],
            quickActions: [
                SliderQuickAction(title: "密度", action: { setDynamicsRetention(0.45) }),
                SliderQuickAction(title: "標準", action: { setDynamicsRetention(0.68) }),
                SliderQuickAction(title: "開放感", action: { setDynamicsRetention(0.85) })
            ],
            stepperActions: (
                decrement: { adjustDynamicsRetention(-0.01) },
                increment: { adjustDynamicsRetention(0.01) }
            )
        ) {
            Slider(
                value: binding(
                    get: { Double(job.editableMasteringSettings.dynamicsRetention) },
                    set: { setDynamicsRetention($0) }
                ),
                in: 0 ... 1,
                step: 0.01
            )
    ...
    private var finishingIntensityControl: some View {
        sliderCard(
            ...
            valueText: String(format: "%.0f%%", Double(job.editableMasteringSettings.finishingIntensity) * 100),
            hintText: "上げすぎると平坦に聞こえやすくなります。",
            scaleLabels: ["自然", "標準", "前に出す"],
            quickActions: [
                SliderQuickAction(title: "自然", action: { setFinishingIntensity(0.35) }),
                SliderQuickAction(title: "標準", action: { setFinishingIntensity(0.55) }),
                SliderQuickAction(title: "強め", action: { setFinishingIntensity(0.75) })
            ],
            stepperActions: (
                decrement: { adjustFinishingIntensity(-0.01) },
                increment: { adjustFinishingIntensity(0.01) }
            )
        ) {
            Slider(
                value: binding(
                    get: { Double(job.editableMasteringSettings.finishingIntensity) },
                    set: { setFinishingIntensity($0) }
                ),
                in: 0 ... 1,
                step: 0.01
            )
    ...
    private var lowToneControl: some View {
        sliderCard(
            ...
            stepperActions: (
                decrement: { adjustLowShelf(-0.05) },
                increment: { adjustLowShelf(0.05) }
            )
        ) {
            Slider(value: binding(get: { Double(job.editableMasteringSettings.lowShelfGain) }, set: { setLowShelf($0) }), in: 0 ... 2.5, step: 0.05)
        }
    }
    ...
    private var lowMidToneControl: some View {
        sliderCard(
            ...
            stepperActions: (
                decrement: { adjustLowMid(-0.05) },
                increment: { adjustLowMid(0.05) }
            )
        ) {
            Slider(value: binding(get: { Double(job.editableMasteringSettings.lowMidGain) }, set: { setLowMid($0) }), in: -1.2 ... 1.2, step: 0.05)
        }
    }
    ...
    private var presenceToneControl: some View {
        sliderCard(
            ...
            scaleLabels: ["奥", "標準", "前"],
            stepperActions: (
                decrement: { adjustPresence(-0.05) },
                increment: { adjustPresence(0.05) }
            )
        ) {
            Slider(value: binding(get: { Double(job.editableMasteringSettings.presenceGain) }, set: { setPresence($0) }), in: 0 ... 1.2, step: 0.05)
        }
    }
    ...
    private var airToneControl: some View {
        sliderCard(
            ...
            stepperActions: (
                decrement: { adjustHighShelf(-0.05) },
                increment: { adjustHighShelf(0.05) }
            )
        ) {
            Slider(value: binding(get: { Double(job.editableMasteringSettings.highShelfGain) }, set: { setHighShelf($0) }), in: 0 ... 2.5, step: 0.05)
        }
    }
    ...
    private var harshnessAmountControl: some View {
        sliderCard(
            ...
            valueText: String(format: "%.0f%%", Double(job.editableMasteringSettings.deEsserAmount) * 100),
            scaleLabels: ["弱い", "標準", "強い"],
            stepperActions: (
                decrement: { adjustDeEsserAmount(-0.01) },
                increment: { adjustDeEsserAmount(0.01) }
            )
        ) {
            Slider(value: binding(get: { Double(job.editableMasteringSettings.deEsserAmount) }, set: { setDeEsserAmount($0) }), in: 0 ... 1, step: 0.01)
        }
    }
    ...
    private var deEssThresholdControl: some View {
        sliderCard(
            ...
            stepperActions: (
                decrement: { adjustDeEssThreshold(-0.5) },
                increment: { adjustDeEssThreshold(0.5) }
            )
        ) {
            Slider(value: binding(get: { Double(job.editableMasteringSettings.deEsserThresholdDB) }, set: { setDeEssThreshold($0) }), in: -36 ... -18, step: 0.5)
        }
    }
    ...
    private var stereoWidthControl: some View {
        sliderCard(
            ...
            stepperActions: (
                decrement: { adjustStereoWidth(-0.01) },
                increment: { adjustStereoWidth(0.01) }
            )
        ) {
            Slider(value: binding(get: { Double(job.editableMasteringSettings.stereoWidth) }, set: { setStereoWidth($0) }), in: 0.8 ... 1.4, step: 0.01)
        }
    }
    ...
    private var saturationControl: some View {
        sliderCard(
            ...
            stepperActions: (
                decrement: { adjustSaturation(-0.01) },
                increment: { adjustSaturation(0.01) }
            )
        ) {
            Slider(value: binding(get: { Double(job.editableMasteringSettings.saturationAmount) }, set: { setSaturation($0) }), in: 0 ... 0.45, step: 0.01)
        }
    }
    ...
    private func compressorControlCard(
        ...
        VStack(alignment: .leading, spacing: 12) {
            ...
            compressorSliderBlock(
                ...
                stepperActions: (
                    decrement: { onChange(.threshold, clamped(Double(settings.thresholdDB) - 0.5, lower: -36, upper: -12)) },
                    increment: { onChange(.threshold, clamped(Double(settings.thresholdDB) + 0.5, lower: -36, upper: -12)) }
                )
            ) {
                Slider(
                    value: binding(
                        get: { Double(settings.thresholdDB) },
                        set: { onChange(.threshold, $0) }
                    ),
                    in: -36 ... -12,
                    step: 0.5
                )
            ...
            compressorSliderBlock(
                ...
                stepperActions: (
                    decrement: { onChange(.ratio, clamped(Double(settings.ratio) - 0.05, lower: 1.1, upper: 4.0)) },
                    increment: { onChange(.ratio, clamped(Double(settings.ratio) + 0.05, lower: 1.1, upper: 4.0)) }
                )
            ) {
                Slider(
                    value: binding(
                        get: { Double(settings.ratio) },
                        set: { onChange(.ratio, $0) }
                    ),
                    in: 1.1 ... 4.0,
                    step: 0.05
                )
        ...
        VStack(alignment: .leading, spacing: 7) {
            HStack(alignment: .firstTextBaseline) {
                Text(title)
                    ...
                    .foregroundStyle(.secondary)
                Spacer()
                if let stepperActions {
                    HStack(spacing: 4) {
                        Button("-") {
                            stepperActions.decrement()
                        }
                        Button("+") {
                            stepperActions.increment()
                        }
                    }
            ...
            HStack {
                ForEach(Array(scaleLabels.enumerated()), id: \.offset) { _, label in
                    Text(label)
                        .font(.caption2)
                        .foregroundStyle(.secondary)
                        .frame(maxWidth: .infinity, alignment: alignment(forScaleLabel: label, in: scaleLabels))
                }
            }
    ...
    private func setTargetLoudness(_ value: Double) {
        job.updateMasteringSettings { settings in
            settings.targetLoudness = Float(clamped(value, lower: -18, upper: -9))
        }
    }

    private func adjustTargetLoudness(_ delta: Double) {
        setTargetLoudness(Double(job.editableMasteringSettings.targetLoudness) + delta)
    }

    private func setPeakCeiling(_ value: Double) {
        job.updateMasteringSettings { settings in
            settings.peakCeilingDB = Float(clamped(value, lower: -2, upper: -0.2))
        }
    }

    private func adjustPeakCeiling(_ delta: Double) {
        setPeakCeiling(Double(job.editableMasteringSettings.peakCeilingDB) + delta)
    }

    private func setDynamicsRetention(_ value: Double) {
        job.updateMasteringSettings { settings in
            settings.dynamicsRetention = Float(clamped(value, lower: 0, upper: 1))
        }
    }

    private func adjustDynamicsRetention(_ delta: Double) {
        setDynamicsRetention(Double(job.editableMasteringSettings.dynamicsRetention) + delta)
    }

    private func setFinishingIntensity(_ value: Double) {
        job.updateMasteringSettings { settings in
            settings.finishingIntensity = Float(clamped(value, lower: 0, upper: 1))
        }
    }

    private func adjustFinishingIntensity(_ delta: Double) {
        setFinishingIntensity(Double(job.editableMasteringSettings.finishingIntensity) + delta)
    }

    private func setLowShelf(_ value: Double) {
        job.updateMasteringSettings { settings in
            settings.lowShelfGain = Float(clamped(value, lower: 0, upper: 2.5))
        }
    }

    private func adjustLowShelf(_ delta: Double) {
        setLowShelf(Double(job.editableMasteringSettings.lowShelfGain) + delta)
    }

    private func setLowMid(_ value: Double) {
        job.updateMasteringSettings { settings in
            settings.lowMidGain = Float(clamped(value, lower: -1.2, upper: 1.2))
        }
    }

    private func adjustLowMid(_ delta: Double) {
        setLowMid(Double(job.editableMasteringSettings.lowMidGain) + delta)
    }

    private func setPresence(_ value: Double) {
        job.updateMasteringSettings { settings in
            settings.presenceGain = Float(clamped(value, lower: 0, upper: 1.2))
        }
    }

    private func adjustPresence(_ delta: Double) {
        setPresence(Double(job.editableMasteringSettings.presenceGain) + delta)
    }

    private func setHighShelf(_ value: Double) {
        job.updateMasteringSettings { settings in
            settings.highShelfGain = Float(clamped(value, lower: 0, upper: 2.5))
        }
    }

    private func adjustHighShelf(_ delta: Double) {
        setHighShelf(Double(job.editableMasteringSettings.highShelfGain) + delta)
    }

    private func setDeEsserAmount(_ value: Double) {
        job.updateMasteringSettings { settings in
            settings.deEsserAmount = Float(clamped(value, lower: 0, upper: 1))
        }
    }

    private func adjustDeEsserAmount(_ delta: Double) {
        setDeEsserAmount(Double(job.editableMasteringSettings.deEsserAmount) + delta)
    }

    private func setDeEssThreshold(_ value: Double) {
        job.updateMasteringSettings { settings in
            settings.deEsserThresholdDB = Float(clamped(value, lower: -36, upper: -18))
        }
    }

    private func adjustDeEssThreshold(_ delta: Double) {
        setDeEssThreshold(Double(job.editableMasteringSettings.deEsserThresholdDB) + delta)
    }

    private func setStereoWidth(_ value: Double) {
        job.updateMasteringSettings { settings in
            settings.stereoWidth = Float(clamped(value, lower: 0.8, upper: 1.4))
        }
    }

    private func adjustStereoWidth(_ delta: Double) {
        setStereoWidth(Double(job.editableMasteringSettings.stereoWidth) + delta)
    }

    private func setSaturation(_ value: Double) {
        job.updateMasteringSettings { settings in
            settings.saturationAmount = Float(clamped(value, lower: 0, upper: 0.45))
        }
    }

    private func adjustSaturation(_ delta: Double) {
        setSaturation(Double(job.editableMasteringSettings.saturationAmount) + delta)
    }
