...
struct StemModeCorrectionSettingsViewTests {
    ...
    func stemInspectorSelectsOneRoleAndUsesStandardKnobsForRoleSpecificSettings() throws {
        ...
        #expect(correctionView.contains("model.availableStemRoles"))
        #expect(correctionView.contains("maxWidth: 448"))
        ...
        #expect(controlList.contains("DAWResponsiveThreeControlLayout"))
        #expect(!controlList.contains("ViewThatFits(in: .horizontal)"))
        #expect(controlList.contains("DAWKnobMetrics.twoColumnWidth"))
        #expect(standard.contains("DAWResponsiveThreeControlLayout"))
        #expect(!standard.contains("correctionBasicThreeColumnRow"))
        #expect(!standard.contains("correctionBasicTwoColumnRow"))
        #expect(!standard.contains("correctionBasicOneColumnRow"))
