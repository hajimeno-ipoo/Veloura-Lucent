...
struct VelouraScrollIndicatorTests {
    @Test
    func contentAnchorConfiguresTheEnclosingScrollView() throws {
        try autoreleasepool {
            let content = VStack {
            ...
            let expectedAlpha: CGFloat = NSWorkspace.shared
                .accessibilityDisplayShouldIncreaseContrast ? 1 : 0.55
