...
struct VelouraAppRuntimeTests {
    ...
    func appEntryUsesRootAndShutsDownOnlyAtApplicationTermination() throws {
        ...
        #expect(appSource.contains("UNUserNotificationCenterDelegate"))
        ...
        #expect(appSource.contains("UNNotificationDefaultActionIdentifier"))
        #expect(appSource.contains("window.deminiaturize(nil)"))
