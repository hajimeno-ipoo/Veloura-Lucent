...
- [x] 初回取得・破損時・完全再取得を1つの「AIモデルを取得」に統一し、右サイド「アプリ」タブの「Stem分離」へ統合。手動の「モデル検証」と「選択できる操作」の見出しは置かない
...
- 2026-07-24、専用モデル管理画面を廃止し、右サイド「アプリ」タブの「Stem分離」へモデル状態と取得を統合した。2026-07-30、初回・破損時・完全再取得の表示を1つの「AIモデルを取得」へ統一した。2026-07-31、手動の「モデル検証」と「選択できる操作」の見出しを削除し、起動時・モデル切替時の自動検証だけを残した。
